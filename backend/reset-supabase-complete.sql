-- Script completo para resetar e reconfigurar o Supabase
...
-- 3. REMOVER TODAS AS TABELAS EXISTENTES (em ordem para evitar conflitos de FK)
...
-- 4. RECRIAR TABELA UNITS (deve ser criada primeiro por causa das FKs)
CREATE TABLE units (
...
-- 13. CRIAR POLÍTICAS RLS SIMPLES (SEM RECURSÃO)
...
VALUES (
    gen_random_uuid(),
    'admin@sistema.com',
    '$2b$10$example.hash.here', -- Você deve gerar um hash real
    'Administrador',
    'admin',
...
-- Script concluído!
-- Execute este script no SQL Editor do Supabase para resetar completamente o banco