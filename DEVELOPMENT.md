...
```bash
git remote add encore encore://crm-multi-acesso-cxzi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/crm-multi-acesso-cxzi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/crm-multi-acesso-cxzi/settings/integrations/github)
